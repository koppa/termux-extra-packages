...
TERMUX_PKG_DEPENDS="adwaita-icon-theme, coreutils, desktop-file-utils, gtk-update-icon-cache, libatk, libcairo-x, librsvg, libxcomposite, libxcursor, libxdamage, libxi, libxinerama, libxrandr, pango-x, shared-mime-info"
...
TERMUX_PKG_RM="bin/gtk-update-icon-cache"
