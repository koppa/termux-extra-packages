...
TERMUX_PKG_DEPENDS="libandroid-glob, libcairo-x, libev, libposix-shm, libxkbcommon, pango, pcre, startup-notification, xcb-util-cursor, xcb-util-keysyms, xcb-util-wm, xcb-util-xrm, yajl"
