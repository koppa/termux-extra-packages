...
TERMUX_PKG_DEPENDS="glib, libandroid-shmem, libandroid-support, libbz2, libcurl, libgnutls, libjpeg-turbo, liblzo, libnettle, libpixman, libpng, libsasl, libsdl, libseccomp, libssh2, libutil, ncurses"
