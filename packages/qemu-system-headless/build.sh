...
TERMUX_PKG_DEPENDS="glib, libandroid-support, libbz2, libcurl, libgnutls, libjpeg-turbo, liblzo, libnettle, libpixman, libpng, libseccomp, libssh2, libutil, ncurses"
...
termux_step_post_massage()
{
    (
        ...
        ## gzip manpages
        cd ${TERMUX_PKG_MASSAGEDIR}/${TERMUX_PREFIX}/share/man
        gzip -9 $(find . -type f)
