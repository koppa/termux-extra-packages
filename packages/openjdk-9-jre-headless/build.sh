...
reponames=(jdk9 corba hotspot jaxp jaxws jdk langtools nashorn cups)
...
termux_step_post_make_install () {
    ...
    for binary in ${TERMUX_PREFIX}/${_jvm_dir}/bin/*; do
...

        {
            ...
            echo "export JAVA_HOME=\${PREFIX}/${_jvm_dir}"
            echo "export LD_LIBRARY_PATH=\${LD_LIBRARY_PATH}:\${JAVA_HOME}/lib:\${JAVA_HOME}/lib/jli"
            echo "exec \${JAVA_HOME}/bin/${binary} \"\${@}\""
